"""
Django settings for djangoRestProjectStartOver project.
...
SECRET_KEY = 'mvkxo8ra@-&_^=m))$ch)v4+5_9ej&1468p3!psm1mpet&iccv'
...
ROOT_URLCONF = 'djangoRestProjectStartOver.urls'
...
WSGI_APPLICATION = 'djangoRestProjectStartOver.wsgi.application'
